...
SECRET_KEY = '#r8#trp!zmpun-*z6com#--n0(1rd82iq#jrxcb=$j5v-a0)ln'
...
ROOT_URLCONF = 'myheroku.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'myheroku.wsgi.application'
...
ALLOWED_HOSTS = ['herokumarina.herokuapp.com']
...
if not DEBUG:
    ...
    STATIC_URL = S3_URL%s % STATIC_URL
    MEDIA_URL=S3_URL%s % MEDIA_URL